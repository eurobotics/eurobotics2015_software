...
#define STANDS_EXCHANGER_K_IMP_mm			(52296.0/259.0)
#define STANDS_EXCHANGER_CALIB_IMP_MAX		(-52296/2)
#define STANDS_EXCHANGER_POSITION_MAX_mm	(130)
#define STANDS_EXCHANGER_POSITION_CENTER_mm	0
#define STANDS_EXCHANGER_POSITION_MIN_mm	(-130)
