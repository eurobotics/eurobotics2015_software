...
#define AX12_FRONT_BELT_L	4
#define AX12_FRONT_BELT_R	3
#define AX12_REAR_BELT_L	1
#define AX12_REAR_BELT_R	2

#define AX12_RIGHT_MIRROR	5
#define AX12_LEFT_MIRROR	6

#define S_FRONT_TOKEN_STOP		SENSOR5
#define S_FRONT_TOKEN_CATCHED	SENSOR1
#define S_REAR_TOKEN_STOP		SENSOR4
#define S_REAR_TOKEN_CATCHED	SENSOR3
