...
struct strat_infos strat_infos = {
   ...
   /*zones[W] =                 {type,             x,         y,         					x_down,    x_up,   y_down, y_up,  init_x,       init_y, prio,         flags,        opp_time_zone_us,	last_time_opp_here,	robot };  */
	...
	.zones[ZONE_POPCORNCUP_2]=        {ZONE_TYPE_POPCORNCUP,  MY_POPCORNCUP_SIDE_X,     MY_POPCORNCUP_SIDE_Y, 	100, 	 400,    100,    400,			MY_POPCORNCUP_SIDE_X+300,	LIMIT_BBOX_Y_DOWN,                    0,     0,            0,					(9000*1000L),					SEC_ROBOT},
