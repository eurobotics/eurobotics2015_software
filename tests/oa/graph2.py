...
print("go_in_area_1.png", 20, 100, 45, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)

graph("go_in_area_1.png", 20, 100, 45, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)

for i in range (0,3000,200):
    for j in range(0,2000,200):
        graph('cua_1_{}-{}.png'.format(i,j), i, j, 0, 250, 250, -1500, 0, -1500, 0, -1500, 0)
        graph('cua_2_{}-{}.png'.format(i,j), i, j, 0, 250, 1600, -1500, 0, -1500, 0, -1500, 0)
        graph('cua_3_{}-{}.png'.format(i,j), i, j, 0, 2750, 1600, -1500, 0, -1500, 0, -1500, 0)
        graph('cua_4_{}-{}.png'.format(i,j), i, j, 0, 2750, 250, -1500, 0, -1500, 0, -1500, 0)