...
print("escape_home_yellow.png", 400, 1200, 0, 700, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("escape_home_yellow.png", 400, 1200, 0, 700, 1600, -1500, 0, -1500, 0, -1500, 0)

print("escape_home_green.png", 2800, 1001, 0, 2300, 1000, -1500, 0, -1500, 0, -1500, 0)
graph("escape_home_green.png", 2800, 1001, 0, 2300, 1000, -1500, 0, -1500, 0, -1500, 0)


print("escape_opp_1.png", 1500, 1000, 0, 300, 1600, 1600, 750, -1500, 0, -1500, 0)
graph("escape_opp_1.png", 1500, 1000, 0, 300, 1600, 1600, 750, -1500, 0, -1500, 0)

print("escape_opp_2.png", 1500, 1000, 0, 300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("escape_opp_2.png", 1500, 1000, 0, 300, 1600, -1500, 0, 1300, 1000, -1500, 0)


print("escape_2nd_robot.png", 1500, 1000, 0, 300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("escape_2nd_robot.png", 1500, 1000, 0, 300, 1600, -1500, 0, -1500, 0, 1300, 1000)


print("escape_home_yellow_opp1.png", 400, 1300, 0, 2700, 1600,500,1100, -1500, 0, -1500, 0)
graph("escape_home_yellow_opp1.png", 400, 1300, 0, 2700, 1600, 500 ,1100, -1500, 0, -1500, 0)

print("bbox_xd_yd.png", 15, 15, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("bbox_xd_yd.png", 15, 15, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
print("bbox_yd.png", 2000, 15, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("bbox_yd.png", 2000, 15, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
print("bbox_xd.png", 15, 1500, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("bbox_xd.png", 15, 1500, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
print("bbox_yu.png", 2500, 1980, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("bbox_yu.png", 2500, 1980, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
print("bbox_xu.png", 2980, 500, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("bbox_xu.png", 2980, 500, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
print("bbox_xu_yd.png", 2900, 15, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("bbox_xu_yd.png", 2900, 15, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
print("bbox_xd_yu.png", 15, 1970, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
graph("bbox_xd_yu.png", 15, 1970, 0, 2300, 1600, -1500, 0, -1500, 0, -1500, 0)
